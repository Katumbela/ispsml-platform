  ...
  return (
    <section className="container px-4 py-8 mx-auto">
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
        {/* Featured Conference */}
        <div className="relative grid items-center p-10 overflow-hidden text-white rounded-lg place-content-center md:col-span-1" style={{background: `linear-gradient(90deg, #00000093, #000000AF), url(${images.departImages.ciencias_sociais.src}) center center`, backgroundSize: "cover"}}>
          <div>
          ...
          <span className="px-3 py-1 text-xs font-bold text-gray-500 bg-white rounded-full top-16 left-4">
            Setor Público
          </span>
          <div className="mt-12">
            ...
            <button className="px-4 py-2 font-semibold text-white transition-all rounded-lg bg-primary hover:bg-primary-dark">
              QUERO ME REGISTRAR
            </button>
          </div>
          </div>
        ...
        <div className="space-y-4">
          ...
          {['OUT', 'AGO', 'JUL'].map((month, index) => (
            <div key={index} className="flex items-start p-4 bg-gray-100 rounded-lg shadow-sm">
          ...
          <button className="w-full px-4 py-2 mt-4 font-semibold text-gray-700 border border-gray-500 rounded-lg hover:bg-gray-200">
            Ver mais eventos
          </button>
        </div>
      </div>
