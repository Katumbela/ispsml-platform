...
const YearAccordion: React.FC<YearAccordionProps> = ({ year, isOpen, toggleYear }) => {
  return (
    <div className=''>
      <h2 className={cn("py-4 my-0 text-xl font-semibold  transition-all cursor-pointer text-primary hover:bg-slate-100/80 bg-slate-50 containers flex gap-3")} onClick={() => toggleYear(Number(year.year))}>
        {
