    ...
    <div>
      ...
      <section className="py-20">
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card image={teachers.teacher1.src} title="Notícia 3" description="Descrição da notícia 3." />
          </div>
        </div>
      </section>
      <section className="py-20 bg-gray-100">
      ...
      <section className="py-20">
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card image={teachers.teacher2.src} title="Evento 1" description="Descrição do evento 1." />
            <Card image={teachers.teacher3.src} title="Evento 2" description="Descrição do evento 2." />
            <Card image={teachers.teacher4.src} title="Evento 3" description="Descrição do evento 3." />
          </div>
        </div>
      </section>
      <section className="py-20 bg-gray-100">
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card image={teachers.teacher2.src} title="Estudante 3" description="Testemunho do estudante 3." />
          </div>
        </div>
      </section>
      <section className="py-20">
